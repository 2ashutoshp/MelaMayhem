...
import useOnSameLine from "@/hooks/useOnSameLine";
...
const EventDetailsPage: React.FC<EventDetailsPageProps> = ({ event }) => {
  ...
  const onSameLine = useOnSameLine(startRef, endRef);
